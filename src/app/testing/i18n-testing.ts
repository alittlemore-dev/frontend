...
const I18N_TEST_MESSAGES: Record<string, string> = {
  ...
  'resumeWorkspace.validationWholeResume': 'Всё резюме',
  'resumeWorkspace.validation.maxItems': 'Элементов: {actual}, максимум: {max}.',
  'resumeWorkspace.validation.minItems': 'Минимум {min} элемент.',
  'resumeWorkspace.validation.duplicate': 'Повторяет другой пункт.',
  'resumeWorkspace.limit.characters': 'Символов: {actual} из {max}.',
  'resumeWorkspace.limit.charactersExceeded': 'Превышен лимит: {actual} из {max} символов.',
  'resumeWorkspace.limit.total': 'всего',
  'resumeWorkspace.limit.resumeTextLabel': 'Текст',
  'resumeWorkspace.limit.photoHint': 'JPEG/PNG/WebP · до 10 МБ',
  'resumeWorkspace.limit.phoneDigits': '7–20 цифр',
  'resumeWorkspace.limit.reached': 'лимит',
  'resumeWorkspace.limit.addDisabled': 'Лимит достигнут, добавить ещё один элемент нельзя.',
  'resumeWorkspace.limit.list': 'В этом списке {actual} из {max} элементов.',
  'resumeWorkspace.limit.listTotal': 'Во всём резюме {actual} из {max} элементов.',
  'resumeWorkspace.limit.textTotal': 'Текст резюме: {actual} из {max} символов.',
  'resumeWorkspace.limit.textTotalExceeded':
    'Превышен общий лимит текста: {actual} из {max} символов.',
  ...
  'resumeWorkspace.field.photo': 'Фото',
  ...
  'resumeWorkspace.field.companyWebsiteUrl': 'Сайт компании',
  ...
  'resumeWorkspace.field.teamSize': 'Размер команды',
  'resumeWorkspace.field.scale': 'Масштаб и нагрузка',
  ...
  'resumeWorkspace.action.removePhoto': 'Удалить фото',
  'resumeWorkspace.photoInvalid':
    'Не удалось обработать фото. Выберите JPEG, PNG или WebP размером до 10 МБ.',
  'resumeWorkspace.photoProcessing': 'Обработка фото…',
...
const I18N_TEST_MESSAGES_EN: Record<string, string> = {
  ...
  'resumeWorkspace.field.photo': 'Photo',
  'resumeWorkspace.field.companyWebsiteUrl': 'Company website',
  'resumeWorkspace.field.teamSize': 'Team size',
  'resumeWorkspace.field.scale': 'Scale and load',
  'resumeWorkspace.action.removePhoto': 'Remove photo',
  'resumeWorkspace.photoInvalid':
    'Could not process the photo. Choose a JPEG, PNG, or WebP image up to 10 MB.',
  'resumeWorkspace.photoProcessing': 'Processing photo…',
